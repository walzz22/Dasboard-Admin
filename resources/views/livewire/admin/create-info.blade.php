<div class="max-w-6xl mx-auto py-5 px-4 md:px-0">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-black text-slate-800 tracking-tight">Tambah Info Kantor</h2>
            <p class="text-[11px] text-slate-500 font-medium">Lengkapi semua kolom sesuai dengan format database.</p>
        </div>
